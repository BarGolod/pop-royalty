...
export class DataService {
  ...
  private yearsDescription: any = [
    {
      id: '80s',
      data: "The pop royalty of the 80s revolutionized music distribution and accessibility through key channels. Vinyl records provided a tangible and collectible format, while the advent of MTV turned music videos into powerful promotional tools, shaping the visual identity of pop icons. These artists utilized radio, global tours, and live performances to reach diverse audiences. The fusion of elaborate fashion, merchandising, and visually captivating performances made them not just musicians but influential cultural figures, leaving an indelible mark on the era's music landscape.",
    },
    {
      id: '90s',
      data: "In the dynamic landscape of the 90s, pop royalty continued to evolve, navigating the rise of alternative music and the mainstream popularity of hip-hop. The CD format surged, offering digital clarity, and the internet began to play a role in music sharing and promotion. Iconic MTV shows, like 'TRL', brought real-time audience interaction, while diverse genres found their spotlight. With the emergence of boy bands, girl groups, and solo superstars, the 90s pop royalty expanded their influence globally, shaping the musical tastes of a generation.",
    },
    {
      id: '2000s',
      data: "The 2000s witnessed a digital revolution in the music industry, reshaping how pop royalty reached audiences. Online platforms, including iTunes and later streaming services like Spotify, transformed music consumption. The era embraced a fusion of genres, from R&B to pop-punk, and reality TV shows like 'American Idol' created instant pop sensations. Music videos continued to be influential, transitioning from TV broadcasts to online platforms like YouTube. Pop royalty in the 2000s not only dominated the charts but also became multimedia stars, leveraging the power of the internet to connect with a global fanbase.",
    },
    {
      id: '2010s',
      data: "In the 2010s, pop royalty navigated an era dominated by social media and streaming services. Artists harnessed platforms like Instagram, Twitter, and TikTok to engage directly with fans, shaping a more personalized connection. The rise of streaming, led by Spotify and Apple Music, revolutionized music distribution, emphasizing individual tracks over albums. The decade witnessed the crossover between pop and electronic dance music (EDM), with festivals like Coachella becoming cultural phenomena. The visual aspect remained crucial, with artists utilizing elaborate music videos and visually striking album covers to capture the digital age's attention. The 2010s marked a dynamic shift in how pop royalty both produced and consumed music.",
    },
    {
      id: '2020s',
      data: "While it's still very early to determine if the following artists can be considered 'Pop Royalty,' they've already made a tremendous impact or rather succeeded or peaked in the early stages of this decade. In the 2020s, pop royalty faced an evolving landscape defined by global challenges, technological advancements, and shifting cultural dynamics. The COVID-19 pandemic significantly impacted the music industry, prompting innovative approaches to virtual concerts and digital collaborations.  Streaming platforms continued to dominate, influencing how artists released and promoted their work. Genres blended seamlessly, reflecting a more eclectic and inclusive era in pop music.",
    },
    {
      id: 'Honorable Mentions',
      data: "In the realm of Pop Royalty, these honorable mentions stand as pillars of musical influence, each defining a unique era. From revolutionary contributions in the '50s and '70s to fearless exploration of new territories in the '80s, the indelible impact of the '90s Hip-Hop scene, and the soulful resonance of the 2000s, these figures have left an enduring mark. With captivating vocals, genre-defying sounds, and lyrical prowess, they collectively represent a diverse tapestry that enriches the fabric of pop music history.",
    },
  ];
  ...
  public getContentForDecade(decade: string) {
    const decadeData = this.yearsDescription.find(
      (data: any) => data.id === decade
    );

    if (decadeData) {
      return {
        description: decadeData.data,
        data: this.getDataForDecade(decade),
      };
    }

    return { description: '', data: [] }; // Default case
  }

  private getDataForDecade(decade: string) {
    switch (decade) {
      case '80s':
